...
//   const server = "http://localhost:7000"; // ✅ Backend server URL

// const Admin = () => {
//   const navigate = useNavigate();
//   const { user } = useUserData(); // ✅ Get user data (to check admin access)
//   const { albums, songs, fetchAlbums, fetchSongs } = useSongData(); // ✅ Get albums & songs from context

//   // ✅ Local states for album/song creation
...
//   // ✅ File input handler for image/audio uploads
...
//     try {
//       // ✅ Send POST request to create new album
//       const { data } = await axios.post(`${server}/api/v1/album/new`, formData, {
//         headers: { token: localStorage.getItem("token") },
//       });

//       toast.success(data.message);
//       fetchAlbums(); // ✅ Refresh albums list after adding
//       setBtnLoading(false);
//       setTitle("");
//       setDescription("");
//       setFile(null);
...
//     try {
//       // ✅ Send POST request to create new song
...
//   // ✅ Handler for adding a thumbnail to an existing song
...
//           {songs?.map((e, i) => (
//             <div className="bg-[#181818] p-4 rounded-lg shadow-md" key={i}>
//               {/* ✅ Show thumbnail if available, else option to add */}
//               {e.thumbnail ? (
//                 <img src={e.thumbnail} className="mr-1 w-52 h-52" alt="" />
//               ) : (
